...
export const SupportView = () => (
  <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 p-4 md:p-6">
    ...
    <div className="bg-white dark:bg-sidebar flex h-[30rem] flex-col overflow-hidden rounded-2xl border">
    ...
    <div>
      ...
      <dl className="mt-4 grid gap-4 sm:grid-cols-2">
        {FAQ.map(({ q, a }) => (
          <div
            key={q}
            className="bg-white dark:bg-sidebar rounded-2xl border p-4"
          >
    ...
    <div className="bg-white dark:bg-sidebar flex flex-wrap items-center justify-between gap-3 rounded-2xl border p-4">
